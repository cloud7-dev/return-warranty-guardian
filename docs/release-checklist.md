...
- Logic tests confirm fixture validation, large CSV review filters, preset trust metadata, local OCR engine planning, provider payload fixture coverage, scheduler recipes, PDF fallback diagnostics, and self-hosted send guard behavior.
